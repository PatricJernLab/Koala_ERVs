...
rownames(threeclades.ervcounts.softclips)
# sort
threeclades.ervcounts.softclips <- threeclades.ervcounts.softclips[ (row.names(threeclades.ervcounts)), ]
head(threeclades.ervcounts.softclips)
head(threeclades.ervcounts)
# Take softclip counts from the LC but keep original counts from HC individuals:
threeclades.ervcounts.softclips$Bilbo <- threeclades.ervcounts$Bilbo
threeclades.ervcounts.softclips$Birke <- threeclades.ervcounts$Birke
threeclades.ervcounts.softclips$PacificChocolate <- threeclades.ervcounts$PacificChocolate
...
## write out:
write.csv(threeclades.ervcounts.softclips.renamed, 
          file="koala.threeclades.ervcounts.csv", 
          quote=F)

write.csv(threeclades.ervdetails.softclips, 
          file="koala.threeclades.ervdetails.csv", 
          quote=F)
